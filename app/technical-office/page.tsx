...
import { Briefcase, MapPin, FolderOpen, Loader2, LogOut, User } from "lucide-react"
import Image from "next/image"
import { Button } from "@/components/ui/button"
import { getCurrentTechnicalUser, isSessionValid, logoutTechnicalUser, TechnicalOfficeUser } from "@/lib/technical-office-auth"
...
export default function TechnicalOfficePage() {
  ...
  const [currentUser, setCurrentUser] = useState<TechnicalOfficeUser | null>(null)
            ...
            {currentUser && (
              <div className="flex items-center gap-2">
                <div className="flex items-center gap-2 bg-primary/10 px-3 py-2 rounded-full border border-primary/20">
                  ...
                  <span className="text-sm font-medium text-primary hidden sm:inline">{currentUser.name}</span>
                </div>
                <Button
